...
TEST(encoding_base64, padding_test) {
...
TEST(encoding_base64, multiple_of_three) {
...
TEST(encoding_base64, binary_data) {
...
TEST(encoding_base64, full_ascii) {
...
TEST(encoding_base64, no_padding) {
