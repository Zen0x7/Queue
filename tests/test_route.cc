...
TEST(route, can_be_instanced) {
    auto _controller = std::make_shared<engine::controller>([](const std::shared_ptr<engine::state> &state,
    ...
    engine::route _route({
        ...
        boost::beast::http::verb::post,
                        ...
                        std::make_shared<engine::controller>([](const std::shared_ptr<engine::state> &state,
                                                                const boost::beast::http::request<
                                                                    boost::beast::http::string_body> request)
                        -> boost::asio::awaitable<boost::beast::http::response<boost::beast::http::string_body>> {
                                boost::beast::http::response<boost::beast::http::empty_body> _response{
...
TEST(route, can_be_invoked) {
    ...
    engine::route _route({
        ...
        boost::beast::http::verb::post,
                        ...
                        std::make_shared<engine::controller>([&_executed](const std::shared_ptr<engine::state> &state,
                                                                const boost::beast::http::request<
                                                                    boost::beast::http::string_body> request)
                        -> boost::asio::awaitable<boost::beast::http::response<boost::beast::http::string_body>> {
                                boost::beast::http::response<boost::beast::http::empty_body> _response{
