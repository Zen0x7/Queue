...
TEST(encoding_base64url, padding_test) {
...
TEST(encoding_base64url, binary_data) {
...
TEST(encoding_base64url, full_ascii) {
...
TEST(encoding_base64url, no_padding) {
